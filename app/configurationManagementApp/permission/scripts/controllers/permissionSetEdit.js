...
app.controller('permissionSetEditCtrl', ['$scope', '$rootScope', '$state', 'enums', '$stateParams', 'EC2Restangular', 'mmAlertService', 'mmPermissions', 'entityMetaData',
    function ($scope, $rootScope, $state, enums, $stateParams, EC2Restangular, mmAlertService, mmPermissions, entityMetaData) {
        ...
        $scope.permissions = {entity:{createEdit: true}};
        $scope.editPermissionSet = true;
        ...
        function updateState() {
            if ($scope.$parent.mainEntity != null && $scope.isEditMode) {
               ...
               $scope.editPermissionSet = mmPermissions.hasPermissionBySession(entityMetaData["permissionSet"].permissions.entity.createEdit);
