...
app.config(['$stateProvider', '$urlRouterProvider', 'entityMetaData', function($stateProvider, $urlRouterProvider, entityMetaData) {
  ...
  $stateProvider
    ...
    .state('changepassword', {
      ...
      templateUrl: "infra/views/mmChangePassword.html",
      controller: "mmLoginCtrl",
      resolve: {
        userName: function () {
          return null;
    ...
    .state('forgotpassword', {
      ...
      templateUrl: "infra/views/mmForgotPassword.html",
      controller: "mmLoginCtrl",
      resolve: {
        userName: function () {
          return null;
    ...
    .state('checkyourmailbox', {
      url: "/checkyourmailbox",
      title: "Check Your Mailbox",
      templateUrl: "infra/views/mmCheckYourMailbox.html",
      controller: "mmLoginCtrl",
      resolve: {
        userName: function () {
          return null;
    ...
    .state('resetpassword', {
      url: "/resetpassword?userName&tempKey&isNewUser",
      title: "Change Password",
      templateUrl: "infra/views/mmResetPassword.html",
      controller: "mmLoginCtrl",
      resolve: {
        userName: function () {
          return null;
    ...
    .state('spa.campaign.campaignNew', {
      ...
      permissions: entityMetaData['campaign'].permissions.entity.createEdit
    })
    .state('spa.campaign.campaignEdit', {
      ...
      templateUrl: "media/views/campaignEdit.html",
      controller: 'campaignEditCtrl',
      permissions: entityMetaData['campaign'].permissions.entity
    })
    ...
    .state('spa.campaign.ctsEventsSpreadsheet', {
      url: "/ctsEventsSpreadsheet",
      title: "Edit Click Throughs & Events",
      templateUrl: "media/views/clickThroughsAndEventsSpreadsheet.html",
      controller: 'ctsEventsSpreadsheetCtrl'
    })
    ...
    .state('spa.campaign.campaignsCentral', {
      ...
      controller: 'placementCentralCtrl'
    })
    ...
    .state('spa.campaign.ioList', {
      ...
      templateUrl: "infra/central/views/centralLayout.html",
      controller: "campaignIoCtrl",
      permissions: entityMetaData['campaignIo'].permissions.entity.view
    })
    ...
    .state('spa.configuration.fflags', {
      url: "/fflags",
    ...
    .state('spa.media', {
      ...
      permissions: [entityMetaData['campaign'].permissions.entity,
        entityMetaData['advertiser'].permissions.entity,
        entityMetaData['mediaIo'].permissions.entity.view]
    })
    ...
    .state('spa.media.advertisers', {
      ...
      permissions: entityMetaData['advertiser'].permissions.entity
    })
    ...
    .state('spa.brand.brandNew', {
      ...
      permissions: entityMetaData['brand'].permissions.entity
    })
    ...
    .state('spa.admin', {
      ...
      permissions: [entityMetaData['account'].permissions.entity, entityMetaData['user'].permissions.entity, entityMetaData['site'].permissions.entity]
    })
    ...
    .state('spa.admin.sites', {
      ...
      permissions: entityMetaData['site'].permissions.entity
    })
    //Site Entral
    .state('spa.site', {
      url: "/site/:siteId",
    ...
    //IO List Central
    .state('spa.media.ioList', {
      url: "/ioList",
      title: "Insertion Order List",
      templateUrl: "infra/central/views/centralLayout.html",
      controller: "mediaIoCtrl",
      permissions: entityMetaData['mediaIo'].permissions.entity.view
    })
      .state('spa.media.ioList.ioEdit', {
          url: "/ioEdit",
          title: "Insertion Order Edit",
          templateUrl: "billingApp/insertionOrder/views/ioEdit.html",
          controller: "insertionOrderEditCtrl",
    ...
    .state('spa.sitesection', {
        ...
        .state('spa.strategy.strategyEdit', {
            url: "/strategyEdit",
            title: "New Strategy",
            templateUrl: "csbApp/app/routes/views/decision-diagram.html",
            controller: "decisionDiagram",
    ...
    .state('spa.site.sitesections', {
      ...
      permissions: entityMetaData['site'].permissions.entity
		...
		//Campaigns Central (in Site context)
		.state('spa.site.campaigns', {
			url: '/campaigns',
			type: "campaign",
			title: "View Campaigns",
			templateUrl: 'infra/central/views/centralLayout.html',
		...
		//Accounts Central (in Site context)
		.state('spa.site.accounts', {
			url: '/accounts',
			type: "account",
			title: "View Accounts",
			templateUrl: 'infra/central/views/centralLayout.html',
    ...
    .state('spa.site.siteNew', {
      ...
      permissions: entityMetaData["site"].permissions.entity.create
    })
    //Site Edit - Full Page
    ...
    .state('spa.creativeCentralMain.assetsLibrary.default', {
      url: '/1/tile/:search',
      title: "Assets Library",
    ...
    .state('csb-diagram', {
      url: '/csb/diagram/:diagramID?SessionID&DecisionDiagramID&AccountID&UserID&EnvID&CampaignID',
      title: "CSB - Diagram",
      templateUrl: 'csbApp/app/routes/views/decision-diagram.html',
      controller: 'decisionDiagram',
      resolve: {
    ...
    .state('csb-trafficking', {
      url: '/csb/trafficking/:diagramID?SessionID&DecisionDiagramID&AccountID&UserID&EnvID&CampaignID',
...
//for billing
    ...
    .state('spa.media.versaTags', {
	  ...
	  permissions: entityMetaData['versaTag'].permissions.entity.view
    })
    .state('spa.versaTag', {
    ...
    .state('spa.versaTag.versaTagEdit', {
	  ...
	  permissions: entityMetaData['versaTag'].permissions.entity.edit
    })
    .state('spa.versaTag.versaTagSpreadsheet', {
      url: '/spreadsheet',
      title: "Versa Tag Spreadsheet",
      templateUrl: "versaTag/app/views/versaTagSpreadsheet.html",
      controller: 'versaTagSpreadsheetCtrl'
    })
    // VersaTag Entity - End
    ...
    .state('spa.configuration.permissions', {
      ...
      permissions: [entityMetaData["permission"].permissions.entity, entityMetaData["permissionSet"].permissions.entity]
    })
    ...
    .state('spa.configuration.permissionSets', {
      ...
      permissions: [entityMetaData["permissionSet"].permissions.entity, entityMetaData["permission"].permissions.entity]
    })
    ...
    .state('spa.user.userPermissions', {
      ...
      permissions: entityMetaData["userPermissions"].permissions.entity
    })
    ...
    .state('spa.permission.permissionNew', {
      ...
      permissions: entityMetaData["permission"].permissions.entity.createEdit
    })
    ...
    .state('spa.permissionSet.permissionSetNew', {
      ...
      permissions: entityMetaData["permissionSet"].permissions.entity.createEdit
    })
