...
app.factory('appService', [ 'csb', 'panelFactory', 'GraphFactory', '$http', '$q', 'segmentsFactory', 'decisionTreeService', 'mmAlertService',
  'serverErrorMapper', 'EC2Restangular',
  function (csb, panelFactory, GraphFactory, $http, $q, segmentsFactory, decisionTreeService, mmAlertService, serverErrorMapper, EC2Restangular) {
