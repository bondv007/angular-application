...
app.controller('accountSiteCtrl', ['$scope', '$stateParams', 'mmModal', '$state', function ($scope, $stateParams, mmModal, $state) {
  ...
  function addAccount(){
    $state.go('spa.account.accountAdd');
  }
	...
	$scope.centralDataObject = [
		{ type: 'account', centralActions: centralAccountActions },
		{ type: 'siteAccount', centralActions: centralSiteActions, dataManipulator: siteAccounts2sites }
	];
}]);