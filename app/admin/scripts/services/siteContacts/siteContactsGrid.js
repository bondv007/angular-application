...
app.service('siteContactsGrid', ['enums', function (enums) {
	function getColumnDefinition(columnObj) {
		return [
			{field: 'name', displayName: 'Name', isColumnEdit: true, gridControlType: enums.gridControlType.getName("TextBox"),functionOnCellEdit:columnObj.onCellChanged},
			{field: 'email', displayName: 'Email', isColumnEdit: true, gridControlType: enums.gridControlType.getName("TextBox"), validationFunction: columnObj.emailValidation},
			{field: 'phone', displayName: 'Phone', isColumnEdit: true, gridControlType: enums.gridControlType.getName("TextBox")/*, validationFunction:columnObj.phoneNoValidation*/}//TODO currently phone format validation is disabled
		];
	}
